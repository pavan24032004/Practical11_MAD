package com.pavanpatel.mad11_5b6_75
...
class PersonAdapter(private  val context: Context, private val array: ArrayList<Person>): RecyclerView.Adapter<PersonAdapter.PersonViewHolder>(){
    ...
    init {
        // Initialize the databaseHelper here          databaseHelper = DatabaseHelper(context)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PersonViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.person_item_view,
        parent, false)
